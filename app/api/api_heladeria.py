...
@api_bp.route('/productos/calorias/id/<int:id>', methods=['GET'])
@login_required
...
@api_bp.route('/productos/rentabilidad/id/<int:id>', methods=['GET'])
@login_required
...
@api_bp.route('/productos/costo_produccion/id/<int:id>', methods=['GET'])
@login_required
...
@api_bp.route('/productos/vender/id/<int:id>', methods=['GET'])
@login_required
...
@api_bp.route('/ingredientes/sano/id/<int:id>', methods=['GET'])
@login_required
...
@api_bp.route('/ingredientes/reabastecer/id/<int:id>', methods=['GET'])
@login_required
...
@api_bp.route('/ingredientes/renovar/id/<int:id>', methods=['GET'])
@login_required
